...
md += '**The codes are hidden by default** for a clean site. To show them as small\n';
md += 'numbered tags over each photo spot, add `?photos` to the address, e.g.\n';
md += '`weddings.html?photos`.\n\n';
md += '**Legend**\n\n';
